...
class Login extends \Kotchasan\Login implements \Kotchasan\LoginInterface
{
     ...
     * @param array|string $permission
     *
     * @return array|null คืนค่าข้อมูลสมาชิก (แอเรย์) ถ้าเป็นครูหรือแอดมิน ไม่ใช่คืนค่า null
     */
     ...
     * @param array|string $permission
     *
     * @return array|null คืนค่าข้อมูลสมาชิก (แอเรย์) ถ้าเป็นนักเรียนหรือแอดมิน ไม่ใช่คืนค่า null
     */
